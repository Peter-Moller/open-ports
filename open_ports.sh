#!/bin/bash
#
# Script to list open TCP-connections on Mac OS X 10.6, 10.7, 10.8 and 10.9 and Linux
# © Peter Möller, 2011-2014
# 2011-04-04 / Peter Möller, Dept of Copmuter Science, Lund University
